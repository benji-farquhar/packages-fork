...
class MarkersController: NSObject {
  ...
  func add(_ markersToAdd: [FGMPlatformMarker]) -> Bool {
  ...
  private func addMarker(_ markerToAdd: FGMPlatformMarker) -> Bool {
  ...
  func change(_ markersToChange: [FGMPlatformMarker]) -> Bool {
    var clusterChanged = false
  ...
  private func changeMarker(_ markerToChange: FGMPlatformMarker) -> Bool {
